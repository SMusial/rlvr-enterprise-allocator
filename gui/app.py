...
if ch_num == 1:
    ...
    from chapters.ch08 import render
    render()
elif ch_num == 9:
    from chapters.ch09 import render
    render()
elif ch_num == 10:
    from chapters.ch10 import render
    render()
elif ch_num == 11:
    from chapters.ch11 import render
    render()
elif ch_num == 12:
    from chapters.ch12 import render
    render()
elif ch_num == 13:
    from chapters.ch13 import render
    render()
else:
    st.info(
