...
fn run_ch17_v6(
    ...
    use rlvr_core::ch17_marl::run_ch17_v6;
    let result = run_ch17_v6(seed, n_tech, n_orders, n_ep, alpha, gamma,
...
fn run_ch17_v5(
    ...
    use rlvr_core::ch17_marl::run_ch17_v5;
    let result = run_ch17_v5(seed, n_tech, n_orders, n_ep, alpha, gamma,
                              epsilon_start, epsilon_end, alpha_ind, lambda);
    let json = serde_json::to_string(&result).map_err(|e| {
        pyo3::exceptions::PyRuntimeError::new_err(e.to_string())
    })?;
    Ok(json.into_py(py))
...
fn run_ch17_v4(
    ...
    use rlvr_core::ch17_marl::run_ch17_v4;
    let result = run_ch17_v4(seed, n_tech, n_orders, n_ep, alpha, gamma,
                              epsilon_start, epsilon_end);
    let json = serde_json::to_string(&result).map_err(|e| {
        pyo3::exceptions::PyRuntimeError::new_err(e.to_string())
    })?;
...
fn run_ch17_v3(
    ...
    use rlvr_core::ch17_marl::run_ch17_v3;
    let result = run_ch17_v3(seed, n_tech, n_orders, n_ep, alpha, gamma,
                              epsilon_start, epsilon_end, lambda);
    let json = serde_json::to_string(&result).map_err(|e| {
        pyo3::exceptions::PyRuntimeError::new_err(e.to_string())
    })?;
    Ok(json.into_py(py))
...
fn run_ch17_episode(
    ...
    use rlvr_core::ch17_marl::run_ch17;
    let result = run_ch17(seed, n_tech, n_orders, n_ep, alpha, gamma, epsilon_start, epsilon_end);
    let json = serde_json::to_string(&result).map_err(|e| {
        pyo3::exceptions::PyRuntimeError::new_err(e.to_string())
    })?;
    Ok(json.into_py(py))
...
fn rlvr_py(_py: Python, m: &Bound<PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(run_ch17_v6, m)?);
    m.add_function(wrap_pyfunction!(run_ch17_v5, m)?);
    m.add_function(wrap_pyfunction!(run_ch17_v4, m)?);
